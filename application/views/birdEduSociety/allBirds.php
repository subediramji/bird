 ...
 <?php if(!empty($birds)){ ?>   
    ...
    <div class="row">
      <?php foreach($birds as $allbirds){
        ...
        <a href="<?php echo base_url().'index.php/view/bird/'.$id; ?>"><div class="col-lg-3" style="width: 20%;float: left;margin: 1.5%;padding: 1%; min-height: 290px;outline: 1px solid #fff;">
            <img src="<?php echo base_url().'content/uploads/images/thumb_'.$image; ?>" alt="" width="200" class="img_inner fleft">
